...
`nexara` organization and stores generated credentials in AWS Secrets
Manager.
...
|-------------|----------------------------|--------------|
| stage       | nexara-stage    | Provisioned  |
| prod        | nexara-prod     | Provisioned  |
| dev         | —                          | Not provisioned |
...
State is stored at:
```
s3://sourceplane-<env>/env/<env>/nexara/supabase/terraform.tfstate
```
...
```
sourceplane/nexara/supabase/stage
sourceplane/nexara/supabase/prod
```
