...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Nexara web console.
...
- Per-env Cloudflare Pages projects: `nexara-web-console-next-{dev,stage,prod}`
