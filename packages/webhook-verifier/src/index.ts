 ...
 * signature verifier for nexara outbound webhook deliveries.
 *
...
/**
 * Compute the canonical nexara webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a nexara webhook delivery.
 *
