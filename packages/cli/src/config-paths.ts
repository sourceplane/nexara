...
//   - `~/.config/nexara/credentials.json` (0600)
//   - `~/.config/nexara/config.json`     (0644)
//
// Override via `NEXARA_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/nexara` everywhere
